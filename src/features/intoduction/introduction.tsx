...
export const Introduction = () => {
  ...
  transition={{
    ...
    viewport={{ once: true, amount: 0.3 }}>
     ...
     <svg fill="#e9967a" height="15px" className={hobbyIcon} style={{width: "26px", height: "29px"}} width="15px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 297.00 297.00" stroke="#e9967a" transform="matrix(1, 0, 0, 1, 0, 0)" stroke-width="0.00297">
     <title>Meditation</title>
      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.5940000000000001"></g>
