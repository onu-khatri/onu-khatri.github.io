...
export const AboutMe = () => {
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="sm:px-8 scroll-mt-12"
    >
      <H2Heading>About Me:</H2Heading>

      <p className="my-6 text-justify text-lg">
        I’m a dedicated and curious Full-Stack Software Engineer with over 12
        years of industry experience building fast, scalable, and user-focused
        web applications. I specialize in both frontend and backend development,
        with strong proficiency in .NET Core, Node.js, Angular, and React —
        allowing me to own the full development lifecycle from architecture to
        deployment.
      </p>

      <p className="my-6 text-justify  text-lg">
        As a full-stack developer, I am well-versed in .NET Core and NodeJS for
        back-end support. Also, works on Javascript and its frameworks such as
        Angular and React js. I am able to take ideas from conception to
        completion, handling the entire process from start to finish.
      </p>
      <p className="my-6 text-justify  text-lg">
        Over the years, I’ve worked across diverse domains including job-tech,
        insurance, travel, and market research — consistently delivering
        high-impact features and performance improvements. I’ve led engineering
        teams, driven architectural revamps, and spearheaded migrations from
        legacy systems to modern microservice-based infrastructures.
      </p>

      <ul className="text-lg">
        Here’s what I bring to the table:
        <li>
          💡 A strong problem-solving mindset and ability to simplify complexity
          into clean, maintainable code.{" "}
        </li>
        <li>
          🤝 A collaborative approach to teamwork — I love mentoring, doing code
          reviews, and sharing best practices.{" "}
        </li>
        <li>
          🚀 An agile-first mindset — delivering iteratively with fast feedback
          loops and test-driven development.{" "}
        </li>
        <li>
      ...
      <p className="my-6 text-justify  text-lg">
        Beyond my day job, I’m an active GitHub contributor. I enjoy exploring
        new tech and building small tools, components, and utilities that solve
        real problems. Some of these started as side projects for learning, and
        several are now production-ready and used in real-world applications.
      ...
      <p className="text-justify  my-6 text-lg">
        Whether you're a business owner looking to get started on a web or app
        development project, a developer looking to collaborate on something
        cool, or just wanting to say hi, shoot me a message and let's work
        together.
      </p>
